package com.luxoft.java8.module3.forkjoin.benchmark.variance;
...
public class Variance {
  ...
  public static void main(String... args) {
    ...
    System.out.println(
        "Imperative version done in: " + measurePerf(Variance::varianceImperative, population)
            + " msecs");
    System.out.println(
        "Parallel streams version done in : " + measurePerf(Variance::varianceStreams, population)
            + " msecs");
    System.out.println(
        "ForkJoin version done in : " + measurePerf(Variance::varianceForkJoin, population)
            + " msecs");
  }
  ...
  public static double varianceForkJoin(double[] population) {
    ...
    double total = forkJoinPool
        .invoke(new ForkJoinCalculator(population, new SequentialCalculator() {
          @Override
  ...
  public static class ForkJoinCalculator extends RecursiveTask<Double> {
    ...
    private ForkJoinCalculator(double[] numbers, int start, int end,
